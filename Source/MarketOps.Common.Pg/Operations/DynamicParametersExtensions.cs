...
public static class DynamicParametersExtensions
{
    ...
    {
        dynamicParameters.Add(parameterName, parameterValue, DbType.DateTime2, ParameterDirection.Input);
        return dynamicParameters;
    }

    public static DynamicParameters AddInParamNumeric(this DynamicParameters dynamicParameters, string parameterName, Decimal parameterValue)
    {
        dynamicParameters.Add(parameterName, parameterValue, DbType.Decimal, ParameterDirection.Input);
        return dynamicParameters;
    }
    //#endregion
